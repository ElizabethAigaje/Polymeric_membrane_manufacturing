...
class Mixer_rinsing_water(qs.SanUnit):
    """     
    Dummy mixer to calculate water mass flow for rinsing as function of the plant capacity. 
    
    Parameters
    ----------
    ins : 
        Inlet of rinsing water.
    outs : 
        Outlet of contaminated water.
    rinsing_per_membrane :
        Mass of rinsing water per membrane area, [kg/m^2] (the default is 150 kg/m^2 [1])
    params:
    ...
    The amount of water required for coagulation was calculated based on reference [1], that indicates that wastewater generation in a membrane manufacturing 
    plant can be estimated to be 100-500 L of wastewater. Therefore, the midpoint is 300 L (300 kg) produced during coagulation and rising. Therefore, 
    we assume half of the water produced here and the other half in the coagulation bath.
    ...
    def _init(self, rigorous: Optional[bool]=False,
              conserve_phases: Optional[bool]=False, 
               rinsing_per_membranearea=150, params=None):  
        
        self.rigorous = rigorous
        self.rinsing_per_membranearea=rinsing_per_membranearea
    ...
    def _run(self):
        ...
        rinsing_water_needed = (polymer_needed/p.polymermass_to_membranearea)*self.rinsing_per_membranearea    #kg/h of non-solvent
    ...
    # obtain inlet stream object safely (handles N_ins == 1 or >1)
        ...
        inlet.imass['H2O'] = rinsing_water_needed
