...
class Mixer_water(qs.SanUnit):
    """
    Dummy mixer to calculate water demand in the bore solution as function of the plant capacity. 
    ...
    # compute the solvent mass (kg/h)
        water_mass_kg_h = (p.v_polymersol * p.ratio_boresol_to_polymersol*p.d_boresol *
                         (1-p.solventbore_fraction)) / 1000.0 / 24.0  #kg/h  
    ...
    # obtain inlet stream object safely (handles N_ins == 1 or >1)
        ...
        inlet.imass['H2O'] = water_mass_kg_h
