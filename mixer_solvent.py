...
class Mixer_solvent(qs.SanUnit):
    """
    Dummy mixer to calculate the total amount (polymer solution and bore solution) of solvent needed, calculated as function of the plant capacity.
    ...
    params:
        Variable that stores system-level parameters, [-] (see class 'MembraneParams' in the system-membrane-manufacutaring.py file).
    rigorous :
    ...
    def _init(self, rigorous: Optional[bool]=False,
        ...
        self.params = params
        # self.v_polymersol = v_polymersol
        # self.solvent_fraction = solvent_fraction
        # self.solvent_borefraction =solvent_borefraction
        # self.ratio_boresol_polymersol = ratio_boresol_polymersol
        # self.ratio_boresol_polymersol = ratio_boresol_polymersol
        # self.rho_polymersol = rho_polymersol
        # self.rho_boresol = rho_boresol
    ...
    # obtain inlet stream object safely (handles N_ins == 1 or >1)
        ...
        inlet.imass['NMP'] = solvent_mass_kg_h
